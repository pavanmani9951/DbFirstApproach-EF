...
namespace DbFirstDemo
{
    ...
    public partial class DbFirstDemoDbContext : DbContext
    {
        ...
        [DbFunction("DbFirstDemoDbContext", "funcGetAuthorCourses")]
        public virtual IQueryable<funcGetAuthorCourses_Result> funcGetAuthorCourses(Nullable<int> authorID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<funcGetAuthorCourses_Result>("[DbFirstDemoDbContext].[funcGetAuthorCourses](@AuthorID)", authorIDParameter);
        }
